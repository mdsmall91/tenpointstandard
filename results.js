...
var TPResults = (function () {
  ...
  /* Point order per Field Guide v2 (July 2026):
     01 Property Details, 02 Capital Strategy, 03 Regulatory Approvals,
     04 Guest Experience, 05 Design, 06 Procurement, 07 Schedule,
     08 Cost Certainty, 09 Quality Assurance, 10 Opening Readiness. */
  var PTS = [3, 4, 3, 3, 2, 2, 2, 2, 1, 3];
  var MAX = [12, 16, 12, 12, 8, 8, 8, 8, 4, 12];
  var TITLES = ['Property Details', 'Capital Strategy', 'Regulatory Approvals', 'Guest Experience', 'Design',
    'Procurement', 'Schedule', 'Cost Certainty', 'Quality Assurance', 'Opening Readiness'];
  var SHORT = ['Property', 'Capital', 'Regulatory', 'Guests', 'Design',
    'Procurement', 'Schedule', 'Cost Certainty', 'QA', 'Opening'];
  var CLUSTERS = {
    vision: { pts: [3, 4], possible: 20 },
    deal: { pts: [0, 1, 2, 7], possible: 48 },
    delivery: { pts: [5, 6, 8, 9], possible: 32 }
  };
  ...
  /* Gates in dependency order: land, guest, rights, ground, money, number.
     IDs use v2 numbering: Q[point].[position]. */
  var GATES = [
    { id: 'Q2.2', pi: 1, qi: 1, name: 'Site control',
    ...
    { id: 'Q4.1', pi: 3, qi: 0, name: 'Guest demand',
    ...
    { id: 'Q3.1', pi: 2, qi: 0, name: 'Use rights',
    ...
    { id: 'Q1.3', pi: 0, qi: 2, name: 'Utilities',
    ...
    { id: 'Q2.1', pi: 1, qi: 0, name: 'Capital stack',
    ...
    { id: 'Q8.2', pi: 7, qi: 1, name: 'Budget validation',
  ...
  var LIB = [
    { id: 'L1', lens: 'Lender', title: 'Committed Money, Unvalidated Numbers', severity: 5,
      points: [1, 7], gateQs: ['Q8.2'], actionPoint: 7,
      ...
      conds: [function (c) { return c.y[1] >= 3; }, function (c) { return !c.q(7, 1); }] },

    { id: 'L2', lens: 'Lender', title: 'Demand by Assertion', severity: 5,
      points: [3, 1], gateQs: ['Q4.1'], actionPoint: 3,
      ...
      conds: [function (c) { return !c.q(3, 0); }, function (c) { return c.y[1] >= 2; }] },

    { id: 'L3', lens: 'Lender', title: 'Confidence Without Contingency', severity: 3,
      points: [6, 7], gateQs: [], actionPoint: 7,
      ...
      conds: [function (c) { return c.y[6] >= 3; }, function (c) { return !c.q(7, 2); }] },

    { id: 'PO1', lens: 'Permit official', title: 'Drawings Ahead of Approvals', severity: 4,
      points: [4, 2], gateQs: ['Q3.1'], actionPoint: 2,
      ...
      conds: [function (c) { return c.y[4] >= 3; }, function (c) { return !c.q(2, 0); }] },

    { id: 'PO2', lens: 'Permit official', title: 'Land Without Use Rights', severity: 5,
      points: [1, 2], gateQs: ['Q2.2', 'Q3.1'], actionPoint: 2,
      ...
      conds: [function (c) { return c.q(1, 1) === true; }, function (c) { return !c.q(2, 0); }] },

    { id: 'PO3', lens: 'Permit official', title: 'A Schedule That Does Not Own the Approval Clock', severity: 4,
      points: [6, 2], gateQs: [], actionPoint: 2,
      ...
      conds: [function (c) { return c.y[6] >= 3; }, function (c) { return c.y[2] <= 1; }] },

    { id: 'C1', lens: 'Contractor', title: 'A Schedule Built on Unordered Scope', severity: 4,
      points: [6, 5], gateQs: [], actionPoint: 5,
      ...
      conds: [function (c) { return c.q(6, 2) === true; }, function (c) { return !c.q(5, 0); }] },
    ...
    { id: 'C2', lens: 'Contractor', title: 'Finished Drawings, Never Priced', severity: 4,
      ...
      conds: [function (c) { return c.y[4] >= 3; }, function (c) { return c.y[7] <= 1; }] },

    { id: 'C3', lens: 'Contractor', title: 'No Standard for Done', severity: 2,
      points: [8], gateQs: [], actionPoint: 8,
      ...
      conds: [function (c) { return c.verdictStage === 2; }, function (c) { return c.y[8] <= 1; }] },

    { id: 'D1', lens: 'Design professional', title: 'Designing for Nobody in Particular', severity: 3,
      points: [4, 3], gateQs: [], actionPoint: 3,
      ...
      conds: [function (c) { return c.y[4] >= 2; }, function (c) { return c.y[3] <= 1; }] },

    { id: 'D2', lens: 'Design professional', title: 'Units Before the Plan That Places Them', severity: 4,
      points: [5, 4], gateQs: [], actionPoint: 4,
      ...
      conds: [function (c) { return c.q(5, 0) === true; }, function (c) { return c.y[4] <= 1; }] },

    { id: 'CE1', lens: 'Civil engineer', title: 'Everything Downstream Floats', severity: 5,
      points: [0], gateQs: ['Q1.3'], actionPoint: 0,
      ...
      conds: [function (c) { return !c.q(0, 2); },
              function (c) { for (var i = 0; i < 10; i++) { if (i !== 0 && c.y[i] >= 3) return true; } return false; }] },

    { id: 'CE2', lens: 'Civil engineer', title: 'Cost Confidence Without Ground Truth', severity: 4,
      points: [7, 0], gateQs: ['Q1.3'], actionPoint: 0,
      ...
      conds: [function (c) { return c.y[7] >= 2; }, function (c) { return !c.q(0, 1) || !c.q(0, 2); }] },
    ...
    { id: 'H2', lens: 'Hospitality operator', title: 'A Known Guest You Cannot Yet Serve', severity: 2,
      points: [3, 9], gateQs: [], actionPoint: 9,
      ...
      conds: [function (c) { return c.y[3] >= 3; }, function (c) { return c.y[9] <= 1; }] },

    { id: 'H3', lens: 'Hospitality operator', title: 'Underwriting Without an Operating P&L', severity: 3,
      points: [1, 9], gateQs: [], actionPoint: 9,
      ...
      conds: [function (c) { return c.y[1] >= 2; }, function (c) { return !c.q(9, 2); }] }
  ];

  /* Authored actions for points answered 0 or 1 yes, indexed by v2 point order. */
  ...
  var PROTECT_FINDINGS = [
    { lens: '', title: 'Lock the Pricing Window', protect: true, points: [7],
    ...
    { lens: '', title: 'Set the Acceptance Standard Now', protect: true, points: [8],
    ...
    { lens: '', title: 'Write the Opening Playbook', protect: true, points: [9],
  ...
  var PROTECT_ACTIONS = [
    { point: 7, text: 'Price the current scope with a builder and lock the window: costs move faster than drawings.' },
    { point: 8, text: 'Set the acceptance standard: daily site walks, a tracked punch list, a named owner who closes items.' },
    { point: 9, text: 'Write the opening playbook: staffing, service standards, and the first ninety days of operations.' }
  ];
